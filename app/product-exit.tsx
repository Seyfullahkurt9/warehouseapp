...
export default function ProductExitScreen() {
  ...
  useEffect(() => {
    const fetchStockMovements = async () => {
      try {
        ...
        // Query stock movements where operation type is 'ürün_çıkışı'
        const movementsRef = collection(db, "Stok_Hareketleri");
        const q = query(
          movementsRef, 
          where("firma_id", "==", userData.firma_id),
          where("islem_turu", "==", "ürün_çıkışı")
        );
  ...
  // Fetch filter options (warehouses and customers)
  useEffect(() => {
    const fetchFilterOptions = async () => {
      ...
      try {
        ...
        // Fetch customers who have stock movements
  ...
  const applyFilters = () => {
    ...
    if (customerFilter) {
      filtered = filtered.filter(movement => movement.kaynak_id === customerFilter);
    }
  ...
  const handleDeleteMovement = async () => {
    ...
    try {
      ...
      await addDoc(eylemlerRef, {
        ...
        eylem_aciklamasi: `"${selectedMovement.urun_adi || 'Bilinmeyen ürün'}" ürününe ait ${selectedMovement.miktar} ${selectedMovement.birim} çıkış kaydı silindi.`,
          ...
          <View style={styles.headerBottom}>
            ...
            <View style={styles.headerIcons}>
              ...
              >
                ...
                {(warehouseFilter || customerFilter || dateFilter.startDate || dateFilter.endDate) && (
          ...
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyText}>
              {stockMovements.length > 0 
                ...
                : "Henüz ürün çıkışı bulunmuyor"}
            </Text>
            <Text style={styles.emptySubText}>
              {stockMovements.length > 0 
                ? "Filtre kriterlerini değiştirmeyi deneyin" 
                : "Yeni ürün çıkışı yapılması gerekiyor"}
            </Text>
          </View>
        ) : (
          <FlatList
                ...
                <ScrollView style={styles.modalBody}>
                  ...
                  <View style={styles.detailSection}>
                    ...
                    <View style={styles.detailRow}>
                      ...
                      <Text style={styles.detailValue}>Ürün Çıkışı</Text>
                    </View>
                  ...
                  <View style={styles.detailSection}>
                    ...
                    <View style={styles.detailRow}>
                      <Text style={styles.detailLabel}>Çıkış Miktarı:</Text>
                    ...
                    <View style={styles.detailRow}>
                      <Text style={styles.detailLabel}>Kalan Miktar:</Text>
                      <Text style={styles.detailValue}>
                  ...
                  {selectedMovement.kaynak_id && (
                    <View style={styles.detailSection}>
                      ...
                      <View style={styles.detailRow}>
                        <Text style={styles.detailLabel}>Müşteri ID:</Text>
                        <Text style={styles.detailValue}>{selectedMovement.kaynak_id}</Text>
                      </View>
                    </View>
                  )}
                ...
                <View style={styles.filterSection}>
                  ...
                  <ScrollView style={styles.optionList} nestedScrollEnabled={true}>
                    <TouchableOpacity 
                      style={[
                        styles.filterOption, 
                        customerFilter === null && styles.selectedFilterOption
                      ]}
                    ...
                    {customers.map(customer => (
                      <TouchableOpacity 
                        ...
                        style={[
                          styles.filterOption, 
                          customerFilter === customer.id && styles.selectedFilterOption
                        ]}
                        onPress={() => setCustomerFilter(customer.id)}
                      >
                        <Text style={styles.filterOptionText}>{customer.name}</Text>
