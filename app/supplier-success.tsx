...
export default function SupplierSuccessScreen() {
  return (
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.contentContainer}>
          ...
          <Text style={styles.successMessage}>
            Yeni tedarikçi başarıyla eklenmiştir.
          </Text>
          
          <TouchableOpacity 
            onPress={() => router.push('/suppliers')}
            style={styles.viewSuppliersLink}
          >
            <Text style={styles.viewSuppliersText}>
              Tedarikçi listesine dönmek için tıklayın
            </Text>
          </TouchableOpacity>
        </View>
      </SafeAreaView>
